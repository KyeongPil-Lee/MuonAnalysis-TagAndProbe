...
tool = TransferTool()
tool.user = 'kplee'
# tool.host = 'lxplus.cern.ch' # -- Connection reset by peer error
tool.host = 'lxplus701.cern.ch'
tool.port = 22
tool.do_hadd = False

tool.dic_input_to_outputPath = {
    "/u/user/kplee/SE_UserHome/SingleMuon/crab_TnPTreeZ_v20200610_21Feb2020_SingleMuon_Run2016Bver2_HIPM_GoldenJSON" : "/eos/cms/store/group/phys_muon/TagAndProbe/ULRereco/2016/102X/SingleMuon_Run2016Bver2_HIPM",
