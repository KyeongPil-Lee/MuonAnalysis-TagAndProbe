...
if __name__ == '__main__':
    ...
    # -- Madgraph
    config.General.requestName = 'TnPTreeZ'+version+'UL16MC_DYJetsToLL_M50_Madgraph'
    config.Data.inputDataset = '/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/RunIISummer19UL16RECO-106X_mcRun2_asymptotic_v13-v2/AODSIM'
    config.JobType.psetName = '../../test/zmumu/tp_from_aod_MC_arg.py'
    config.JobType.pyCfgParams = ['globalTag=106X_mcRun2_asymptotic_v13']
