...
version = '_v20190607_notFinishedLumis_'
# 'MultiCRAB' part
if __name__ == '__main__':
    ...
    config.Data.lumiMask = "./notFinishedLumis_Run2018A.json"
    ...
    config.Data.lumiMask = "./notFinishedLumis_Run2018C.json"
    crabCommand('submit', config = config)
    ...
    config.Data.lumiMask = "./notFinishedLumis_Run2018D.json"
    crabCommand('submit', config = config)
