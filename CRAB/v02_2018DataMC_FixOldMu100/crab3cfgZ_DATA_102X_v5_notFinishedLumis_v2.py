...
version = '_v20190702_notFinishedLumis_v2_'
# 'MultiCRAB' part
if __name__ == '__main__':
    ...
    # config.Site.whitelist = ['T2_UK_*', 'T3_UK_*', 'T2_RU_*', 'T3_RU_*', 'T2_BE_*', 'T2_DE_*', 'T2_FR_*', 'T3_FR_*'] # -- mandatory for ignoreLocality option
    config.Data.lumiMask = "./notFinishedLumis_Run2018Av2_20190702.json"
    ...
    config.Data.lumiMask = "./notFinishedLumis_Run2018Cv1_20190702.json"
    crabCommand('submit', config = config)
    ...
    # config.Site.whitelist = ['T2_US_*'] # -- mandatory for ignoreLocality option
    config.Data.lumiMask = "./notFinishedLumis_Run2018Dv2_20190702.json"
    crabCommand('submit', config = config)
