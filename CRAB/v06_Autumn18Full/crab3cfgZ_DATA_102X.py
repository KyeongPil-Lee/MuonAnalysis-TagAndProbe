...
if __name__ == '__main__':
    ...
    config.General.requestName = 'TnPTreeZ'+version+'SingleMuon_Run2018Dv2_GoldenJSON_323524_to_End'
    config.Data.inputDataset = '/SingleMuon/Run2018D-PromptReco-v2/AOD'
    config.JobType.psetName = '../../test/zmumu/tp_from_aod_Data_102X_v11.py'
