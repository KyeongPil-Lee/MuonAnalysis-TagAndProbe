...
if __name__ == '__main__':
    ...
    config.Data.lumiMask = "./notFinishedLumis_Run2017B.json"
    ...
    config.Site.whitelist = ['T2_UK_*', 'T3_UK_*', 'T2_IT_*', 'T3_IT_*', 'T2_BE_*', 'T2_DE_*', 'T2_FR_*', 'T3_FR_*', 'T2_US_*'] # -- mandatory for ignoreLocality option
    config.Data.lumiMask = "./notFinishedLumis_Run2017E.json"
    crabCommand('submit', config = config)
    ...
    config.Site.whitelist = ['T2_UK_*', 'T3_UK_*', 'T2_IT_*', 'T3_IT_*', 'T2_BE_*', 'T2_DE_*', 'T2_FR_*', 'T3_FR_*'] # -- mandatory for ignoreLocality option
    config.Data.lumiMask = "./notFinishedLumis_Run2017F.json"
    crabCommand('submit', config = config)
