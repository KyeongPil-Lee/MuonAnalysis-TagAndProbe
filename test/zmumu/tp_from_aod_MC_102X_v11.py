...
if "CMSSW_8_0_" in os.environ['CMSSW_VERSION']:
    ...
    process.GlobalTag.globaltag = cms.string('102X_upgrade2018_realistic_v11')
    process.source.fileNames = [
        'file:/eos/cms/store/mc/RunIIFall18DRPremix/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/AODSIM/102X_upgrade2018_realistic_v11_ext1-v1/60000/49EDBF4A-C2CD-494B-8E6E-B4CFF9E0C288.root'
    ]
