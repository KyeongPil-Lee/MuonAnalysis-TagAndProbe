#########################################################
#-- usage: cmsRun tp_from_aod_Data_arg.py globalTag=<global tag> inputFile=<inputFile> -- #
#########################################################
...
options.register('globalTag',
                  "106X_dataRun2_v20", # default value
                  VarParsing.multiplicity.singleton, # singleton or list
                  VarParsing.varType.string,         # string, int, or float
                  "Global tag used for the ntuple production")

options.register('inputFile',
                  "/store/data/Run2017E/SingleMuon/AOD/09Aug2019_UL2017-v1/260003/7417C8DE-DCB6-C947-9B0D-99D8B1EA4A49.root", # default value
                  VarParsing.multiplicity.singleton, # singleton or list
                  VarParsing.varType.string,         # string, int, or float
