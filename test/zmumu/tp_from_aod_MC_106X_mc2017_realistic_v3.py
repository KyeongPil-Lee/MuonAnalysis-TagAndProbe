...
if "CMSSW_8_0_" in os.environ['CMSSW_VERSION']:
    ...
    process.GlobalTag.globaltag = cms.string('106X_mc2017_realistic_v3')
    process.source.fileNames = [
        '/store/relval/CMSSW_10_6_0/RelValZMM_13/GEN-SIM-RECO/PU25ns_106X_upgrade2018_realistic_v4-v1/10000/BEFA1EF6-0499-A343-9696-ED44AE4C609A.root',
        '/store/relval/CMSSW_10_6_0/RelValZMM_13/GEN-SIM-RECO/PU25ns_106X_upgrade2018_realistic_v4-v1/10000/FEAA4BDA-EB2B-6148-A5EF-B07FE825C2DB.root',
        '/store/relval/CMSSW_10_6_0/RelValZMM_13/GEN-SIM-RECO/PU25ns_106X_upgrade2018_realistic_v4-v1/10000/67FC3575-4475-9C42-91CD-F600F9D5C27D.root',
    ] 
