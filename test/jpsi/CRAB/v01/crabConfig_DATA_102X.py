...
if __name__ == '__main__':
    ...
    # -- Run2018A
    config.General.requestName = 'TnPTreeJPsi'+version+'Charmonium_Run2018Dv2_GoldenJSON_Upto321221'
    config.Data.inputDataset = '/Charmonium/Run2018D-PromptReco-v2/AOD'
    config.JobType.psetName = '../../tp_from_aod_simple_Data_CtoF_102X_v4.py'
