...
if "CMSSW_7_6_" in os.environ['CMSSW_VERSION']:
    ...
    process.source.fileNames = [
        '/store/mc/RunIIFall18DRPremix/JpsiToMuMu_JpsiPt8_TuneCP5_13TeV-pythia8/AODSIM/102X_upgrade2018_realistic_v11-v2/00000/01FCD5EA-887D-924B-981E-29537BBF7119.root'
    ]
